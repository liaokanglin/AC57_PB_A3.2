...
enum {
    DEVICE_EVENT_IN,       // 设备插入事件，表示设备已被插入或连接
    DEVICE_EVENT_OUT,      // 设备拔出事件，表示设备已被拔出或断开连接
    DEVICE_EVENT_ONLINE,   // 设备上线事件，表示设备已经准备就绪，可以使用
    DEVICE_EVENT_OFFLINE,  // 设备下线事件，表示设备不再可用或离线
    DEVICE_EVENT_CHANGE,   // 设备状态变化事件，表示设备属性或状态发生了变化
};
