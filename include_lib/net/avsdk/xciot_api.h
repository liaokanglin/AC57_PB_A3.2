 ...
 * @return 无.
 */
void avsdk_write_video_nocache(iot_mediastream_type_t stream_type,
                               bool                   is_key_frame,
                               uint64_t               avchannel,
                               uint64_t               timestamp_ms,
                               ipc_AIDesc            *AIDesc,
 ...
 * @return 无.
 */
void avsdk_write_video_data_nocache(iot_mediastream_type_t stream_type,
                                    bool                   is_key_frame,
                                    uint64_t               avchannel,
                                    iot_encrypt_type_t     encrypt_type,
                                    uint64_t               timestamp_ms,
