...
enum element_change_event {
    ON_CHANGE_INIT,             /* 初始化事件，响应顺序：从父控件到子控件，自底向上 */
    ON_CHANGE_TRY_OPEN_DC,      /* 尝试打开显示控制，响应顺序：从子控件到父控件，自底向上 */
    ON_CHANGE_FINISH_OPEN_DC,   /* 完成打开显示控制，响应顺序：从父控件到子控件，自底向上 */
    ON_CHANGE_FIRST_SHOW,       /* 第一次显示控件，响应顺序：从父控件到子控件，自底向上 */
    ON_CHANGE_SHOW_PROBE,       /* 显示前的探测，响应顺序：从父控件到子控件，自底向上 */
    ON_CHANGE_SHOW,             /* 显示控件，响应顺序：从父控件到子控件，自底向上 */
    ON_CHANGE_SHOW_POST,        /* 显示后的处理，响应顺序：从父控件到子控件，自底向上 */
    ON_CHANGE_HIDE,             /* 隐藏控件，响应顺序：单个控件处理 */
    ON_CHANGE_HIGHLIGHT,        /* 高亮显示控件，响应顺序：从父控件到子控件，自底向上 */
    ON_CHANGE_RELEASE_PROBE,    /* 释放前的探测，响应顺序：从子控件到父控件，自底向上 */
    ON_CHANGE_RELEASE,          /* 释放控件，响应顺序：从子控件到父控件，自底向上 */
    ON_CHANGE_ANIMATION_END,    /* 动画结束事件，响应顺序：单个控件处理，仅用户消息 */
    ON_CHANGE_SHOW_COMPLETED,   /* 显示完成，响应顺序：从子控件到父控件，自底向上 */
};
