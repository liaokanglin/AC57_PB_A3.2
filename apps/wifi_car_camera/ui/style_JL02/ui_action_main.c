...
//         //     ui_no_highlight_element_by_id(onkey_sel_item[__this->onkey_sel - 1]); // 取消高亮第一个选择项
//         //     ui_no_highlight_element_by_id(onkey_sel_item1[__this->onkey_sel - 1]); // 取消高亮第二个选择项
//         // }
//         // ui_highlight_element_by_id(HOME_TXT_FILES); // 高亮文件按钮
//         break;
//     case ELM_EVENT_TOUCH_HOLD: // 触摸长按事件
//         UI_ONTOUCH_DEBUG("ELM_EVENT_TOUCH_HOLD\n");
//         break;
...
// .ontouch = file_browse_ontouch, // 将文件浏览触摸事件处理函数注册到按钮
// };
