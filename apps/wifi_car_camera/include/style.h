...
#define ID_WINDOW_VIDEO_REC  PAGE_1  // 视频录制页面，关联 PAGE_1
#define ID_WINDOW_VIDEO_TPH  PAGE_2  // 视频拍照页面，关联 PAGE_2
#define ID_WINDOW_VIDEO_REP  PAGE_3  // 视频回放页面，关联 PAGE_3
#define ID_WINDOW_USB_SLAVE  PAGE_4  // USB 从设备页面，关联 PAGE_4
#define ID_WINDOW_VIDEO_SYS  PAGE_5  // 视频系统设置页面，关联 PAGE_5
