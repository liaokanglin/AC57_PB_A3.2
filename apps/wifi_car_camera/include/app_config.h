...
// #define LCD_DSI_VDO_4LANE_1280x800_RP_X
#define MULTI_LCD_EN
#define LCD_AVOUT
...
#define CONFIG_ROOT_PATH        CONFIG_STORAGE_PATH"/C/"  // 根目录路径，位于存储路径的 C 盘目录下
#define CONFIG_REC_PATH_0       CONFIG_STORAGE_PATH"/C/"CONFIG_REC_DIR_0  // 第一个录制路径，拼接存储路径、C 盘和目录 0
#define CONFIG_REC_PATH_1       CONFIG_STORAGE_PATH"/C/"CONFIG_REC_DIR_0  // 第二个录制路径，拼接存储路径、C 盘和目录 1
#define CONFIG_REC_PATH_2       CONFIG_STORAGE_PATH"/C/"CONFIG_REC_DIR_0  // 第三个录制路径，拼接存储路径、C 盘和目录 1
#define CONFIG_REC_PATH_3       CONFIG_STORAGE_PATH"/C/"CONFIG_REC_DIR_0  // 第四个录制路径，拼接存储路径、C 盘和目录 1
