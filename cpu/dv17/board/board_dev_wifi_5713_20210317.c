...
LCD_PLATFORM_DATA_BEGIN(lcd_data)
    .lcd_name = "ST7701S",
	.lcd_io = {
        .backlight = IO_PORTE_02,
        .backlight_value = 1,

		.lcd_reset   = IO_PORTG_06,
		.lcd_standby = -1,
        .lcd_cs      = -1,
        .lcd_rs      = -1,
        .lcd_spi_ck  = -1,
...
{
	gpio_direction_input(IO_PORTB_12);
	return gpio_read(IO_PORTB_12);
}
#else
...
/* u32 wifi_module_scan_bss(struct netdev_ssid_info *netdev_ssid_info, u32 ssid_cnt) */
/* { */
/* return 0; */
/* } */
#endif
