...
// *INDENT-OFF*
#include "asm/ldo.h"
#if defined CONFIG_BOARD_DEV_5715_20230214_UVC_SLAVE /* 黑色的uvc样机小板 */
...
const struct dac_platform_data dac_data = {
    .ldo_id = 1,
	.pa_mute_port = IO_PORTE_04,//0xff,
	.pa_mute_value = 1,
	.differ_output = 1,
};

const struct adc_platform_data adc_data = {
    .mic_channel = LADC_CH_MIC_L,
